...
def main(argc):
	"""rsync: A Python alternative to the traditional rsync.
        
        usage: rsync SOURCE TARGET"""
        ...
        # elif args['--dry-run']:
        #         cookie.dry_run = 1        
        # elif args["--times"]: # --time is there to guaranty backward compatibility with previous buggy version.
        #         cookie.time = 1
        # elif args["--update"]:
        #         cookie.update = 1
        # elif args["--cvs-ignore"]:
        #         cookie.cvs_ignore = 1
        # elif args["--ignore-time"]:
        #         cookie.ignore_time = 1
        # elif args["--delete"]:
        #         cookie.delete = 1
        # elif args["--delete-excluded"]:
        #         cookie.delete = 1
        #         cookie.delete_excluded = 1
        # elif args["--delete-from-source"]:
        #         cookie.delete_from_source = 1
        # elif args["--size-only"]:
        #         cookie.size_only = 1
        # elif args["--modify-window"]:
        #         cookie.modify_window = int(v)
        # elif args["--existing"]:
        #         cookie.existing = 1
        # elif args["--exclude"]:
        #         cookie.filters = cookie.filters + [convertPattern(v, "-")]
        # elif args["--exclude-from"]:
        #         cookie.filters = cookie.filters + convertPatterns(v, "-")
        # elif args["--include"]:
        #         cookie.filters = cookie.filters + [convertPattern(v, "+")]
        # elif args["--include-from"]:
        #         cookie.filters = cookie.filters + convertPatterns(v, "+")
        # elif args["--version"]:
        #         printVersion()
        #         return 0
