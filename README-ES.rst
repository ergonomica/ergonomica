...
Ergonomica es un multiplatforma lengua de consola, en Python. El objectivo de Ergonomica es modernizar la consola, en un lengua muy fácil, indipendiente de los sistemas operativos.
...
Ergonomica no podía trabajar sin:

- `Colorama`_ de `@tartley`_
- `Suplemon`_ de `@richrd`_
...
.. |homebrew| image:: https://img.shields.io/badge/homebrew-1.0.1-orange.svg
   :target: https://github.com/mtklabs/homebrew-tap
   :alt: Homebrew Version 1.0.1
